...
-- 初始化数据：示例活动
-- category_id: 1=学术讲座, 2=体育运动, 3=文艺演出, 4=志愿服务, 5=社团团建
-- created_by=1 为 admin 用户
-- 时间说明：以 2026-07-18 为当前日期，模拟不同状态的活动
...
('人工智能前沿技术讲座', '邀请国内外知名学者分享人工智能领域的最新研究成果与技术趋势，涵盖大语言模型、计算机视觉、强化学习等方向。', '北洋园校区 46教A110', '2026-08-20 14:00:00', '2026-08-20 17:00:00', '2026-08-18 23:59:59', 300, 299, 1, 'UPCOMING', 1),
...
-- ONGOING（正在进行中）
('程序设计竞赛集训营', '为期两周的算法与编程集训，覆盖数据结构、动态规划、图论等竞赛知识点，为下半年的区域赛做准备。', '北洋园校区 45教B211', '2026-07-15 08:30:00', '2026-07-28 17:30:00', '2026-07-12 23:59:59', 80, 64, 1, 'ONGOING', 1),
('社团骨干领导力培训', '面向全校社团骨干成员的封闭式培训，内容涵盖团队管理、活动策划、沟通技巧、危机处理等模块。', '卫津路校区 大学生活动中心 201', '2026-07-16 09:00:00', '2026-07-20 18:00:00', '2026-07-10 23:59:59', 40, 35, 5, 'ONGOING', 1),

-- ENDED（已结束）
('学术论文写作工坊', '由研究生导师指导论文选题、文献综述、实验设计和写作规范，帮助同学们掌握学术写作的核心技能。', '北洋园校区 教学楼 3 号楼 201', '2026-06-20 14:00:00', '2026-06-20 17:00:00', '2026-06-18 23:59:59', 60, 60, 1, 'ENDED', 1),
('校园马拉松赛', '一年一度的校园马拉松赛事，设置全程、半程和迷你跑三个组别，全校师生均可报名参加。', '北洋园校区 主体育场', '2026-05-15 07:00:00', '2026-05-15 12:00:00', '2026-05-10 23:59:59', 1000, 856, 2, 'ENDED', 1),
('"五月花海"校园合唱比赛', '以学院为单位参加的大型合唱比赛，每个学院选派一支队伍，曲目自选，由校内外专业评委评分。', '卫津路校区 大学生活动中心礼堂', '2026-05-20 18:30:00', '2026-05-20 21:00:00', '2026-05-15 23:59:59', 800, 720, 3, 'ENDED', 1),
...
('社团招新嘉年华', '新学期社团联合招新活动，近百个社团将在北洋广场设立展位，现场展示社团风采，吸引新生加入。', '北洋园校区 北洋广场', '2026-03-05 10:00:00', '2026-03-05 17:00:00', '2026-03-03 23:59:59', 999, 999, 5, 'ENDED', 1),
